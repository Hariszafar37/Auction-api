...
class AuctionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Idempotent: keyed on title so re-running on every deploy never duplicates.
        // firstOrCreate (not updateOrCreate) so a live status change made via the
        // admin panel is never reset back to the seeded draft/scheduled value.
