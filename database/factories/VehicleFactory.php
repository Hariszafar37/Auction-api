...
class VehicleFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'asset_number'    => $this->faker->optional(0.4)->bothify('AST-####'),
            'exterior_color'  => $this->faker->optional(0.8)->colorName(),
            'interior_color'  => $this->faker->optional(0.6)->randomElement(['Black', 'Gray', 'Beige', 'Tan', 'Brown']),
            'interior_seating_type' => $this->faker->optional(0.6)->randomElement(['Cloth', 'Leather', 'Leatherette', 'Vinyl']),
            'mileage'         => $this->faker->optional(0.9)->numberBetween(0, 200000),
            'odometer_status' => $this->faker->optional(0.7)->randomElement(['actual', 'not_actual', 'tmu']),
            'number_of_keys'  => $this->faker->optional(0.6)->numberBetween(0, 3),
            'number_of_fobs'  => $this->faker->optional(0.6)->numberBetween(0, 2),
