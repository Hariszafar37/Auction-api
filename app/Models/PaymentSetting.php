...
class PaymentSetting extends Model
{
    ...
    protected $casts = [
        ...
        'seller_registration_fee'     => 'decimal:2',
        'seller_commission_rate'      => 'decimal:2',
        'seller_commission_threshold' => 'integer',
        'seller_commission_flat'      => 'decimal:2',
        'seller_no_sale_fee'          => 'decimal:2',
        'seller_release_days'         => 'integer',
    ...
    public static function defaults(): array
    {
        return [
            ...
            'late_fee_amount'       => 50,
            'seller_registration_fee'     => 50,
            'seller_commission_rate'      => 10,
            'seller_commission_threshold' => 1000,
            'seller_commission_flat'      => 100,
            'seller_no_sale_fee'          => 50,
            'seller_release_days'         => 7,
