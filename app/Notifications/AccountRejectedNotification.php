    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        ...
        [$subject, $body, $nextStep] = match ($this->context) {
            'dealer' => [
                ...
                'Thank you for applying to become a dealer on Colonial Auto Auction. After reviewing your application, we are unable to approve it at this time.',
            ...
            'seller' => [
                ...
                'Thank you for applying to sell on Colonial Auto Auction. After reviewing your application, we are unable to grant seller access at this time.',
            ...
            'government' => [
                ...
                'Thank you for your interest in Colonial Auto Auction. After reviewing your government account application, we are unable to approve it at this time.',
